...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var res, p, bs, localConnector, bc;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    commander
                        .version("0.0.1-alpha")
                        .parse(process.argv);
                    p = new Promise(function (resolve, reject) { res = resolve; });
                    ...
                    localConnector = new buttplug_1.ButtplugEmbeddedServerConnector();
                    localConnector.Server = bs;
                    bc = new buttplug_1.ButtplugClient("Buttplug Local Client");
                    return [4 /*yield*/, bc.Connect(localConnector)];
                case 1:
                    _a.sent();
                    bc.on("deviceadded", function (d) {
                        console.log("Device Found: " + d.Name);
                        res();
                    });
                    console.log("starting scan");
                    return [4 /*yield*/, bc.StartScanning()];
                case 2:
                    _a.sent();
